...
public class WitherHeadBullet : ArrowBullet
{
   ...
   {
      AttackManager.Instance.Explosion(new AttackInfo(owner,AttackType.Physics,Mathf.CeilToInt(handWeapon.attackValue*1.5f)), handWeapon,victim.GetVictimPosition(),15);
